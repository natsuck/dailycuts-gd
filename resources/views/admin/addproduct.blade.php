                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="fresh_storage" class="form-control" placeholder="e.g. Keep chilled" value="{{ old('fresh_storage') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label><strong>Prep</strong></label>
                                        <input type="text" name="fresh_prep" class="form-control" placeholder="e.g. Cook thoroughly" value="{{ old('fresh_prep') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label><strong>Delivery</strong></label>
                                        <input type="text" name="fresh_delivery" class="form-control" placeholder="e.g. Temperature-controlled" value="{{ old('fresh_delivery') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3 mb-md-0">
                                        <label><strong>Best For</strong></label>
                                        <input type="text" name="fresh_best_for" class="form-control" placeholder="e.g. Daily meals" value="{{ old('fresh_best_for') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
